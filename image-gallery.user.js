...
(function () {
  ...
  // Modify the startSiteCrawler function
  function startSiteCrawler() {
    if (isProcessing) return;
    isProcessing = true;
    isCrawlerActive = true; // Add this line - it was missing!
  ...
  // Modify the processPendingLinks function
  ...
  // Modify the updateCrawlerProgress function
  ...
  // Modify the createCrawlerProgressUI function
